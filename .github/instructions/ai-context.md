# AI Context & Instructions for ha-eversports

## 🧬 Project DNA
**Repository:** `ha-eversports`
**Type:** Home Assistant Custom Integration
**Domain:** `eversports`
**Description:** Track court availability from **Eversports** directly in Home Assistant.
...
### 🚀 Google Antigravity
- **Codebase Navigation:** Begin by analyzing `custom_components/eversports/`. Search for established patterns in `api.py` or `coordinator.py` before modifying entities.
